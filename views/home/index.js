            ...
            <div id="halfs" class="flex flex-row h-full">
                <div id="left" class=" w-1/5 p-2">
                    <div id="profile-pic" class="py-1">
                        <img id="profile-pic-display" class="rounded-full h-24 w-auto mx-auto" src="${post.profilePic ? post.profilePic : '/uploads/1720998772627-foto de persona feliz.png'}" alt="foto-perfil">
                    </div>
                    <div id="interactions">
